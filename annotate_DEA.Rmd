...
for(i in stage){
  ...
  write.csv(file=paste("/Users/Marta/Documents/WTCHG/DPhil/Data/Results/Diff_v2/Voom/conservative_counts/",currentDate,"GOstats_GO_BP_",i,"_sig_result_mixed_adjustments_logFC1.csv",sep=""),GO_list[[i]],row.names=F)
