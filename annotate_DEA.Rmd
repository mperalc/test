...
for (i in stage){
  ...
  png(paste("/Users/Marta/Documents/WTCHG/DPhil/Plots/conservative_counts/GO_histograms/GO_histogram_",i,".png",sep=""), type="cairo",
...
for(i in stage){
    ...
    # change name according to method used to calculate adjusted p-vals
  write.csv(file=paste("/Users/Marta/Documents/WTCHG/DPhil/Data/Results/Diff_v2/Voom/conservative_counts/GOstats_GO_BP_",i,"_sig_result_mixed_adjustments.csv",sep=""),GO_list[[i]],row.names=F)
