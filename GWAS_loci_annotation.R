...
for(s in stage){
  ...
  write.table(merged_GWAS_50[[s]][,c(1:15)],quote=F,row.names=F,file=paste("/Users/Marta/Documents/WTCHG/DPhil/Data/Results/Diff_v2/Voom/conservative_counts/comparison_with_and_without_contrasts/GWAS_and_OMIM/50kb/",
                                                         currentDate,"_allinfo_DEA_maxvals_logFC1_50kbs_around_GWAS_loci_",s,".tsv",sep=""),sep="\t")
  
  write.table(merged_GWAS_100[[s]][,c(1:15)],quote=F,row.names=F,file=paste("/Users/Marta/Documents/WTCHG/DPhil/Data/Results/Diff_v2/Voom/conservative_counts/comparison_with_and_without_contrasts/GWAS_and_OMIM/100kb/",
                                                                           currentDate,"_allinfo_DEA_maxvals_logFC1_100kbs_around_GWAS_loci_",s,".tsv",sep=""),sep="\t")
  write.table(merged_GWAS_150[[s]][,c(1:15)],quote=F,row.names=F,file=paste("/Users/Marta/Documents/WTCHG/DPhil/Data/Results/Diff_v2/Voom/conservative_counts/comparison_with_and_without_contrasts/GWAS_and_OMIM/150kb/",
