...
# save longitudinal plots
   ...
   make_long_plots=function(y,.tpm=tpm,.samples=samples,n=9,.stage_2=stage_2,name){
     ...
     ggsave(paste("/Users/Marta/Documents/WTCHG/DPhil/Plots/conservative_counts/contrasts/with_correlation/Diff_v2_top9genes_long_plots",name,sep="_"),p,compression="lzw")
