...
write.table(alltable,quote=F,row.names=F,sep="\t",file="230916_diff_expression_results.tsv")
...
write.table(sig_iPSC_stage,quote=F,row.names=F,sep="\t",file="230916_sig_iPSC_diff_expression_results.tsv")
write.table(sig_DE_stage,quote=F,row.names=F,sep="\t",file="230916_sig_DE_diff_expression_results.tsv")
write.table(sig_PGT_stage,quote=F,row.names=F,sep="\t",file="230916_sig_PGT_diff_expression_results.tsv")
write.table(sig_PFG_stage,quote=F,row.names=F,sep="\t",file="230916_sig_PFG_diff_expression_results.tsv")
write.table(sig_PE_stage,quote=F,row.names=F,sep="\t",file="230916_sig_PE_diff_expression_results.tsv")
write.table(sig_EP_stage,quote=F,row.names=F,sep="\t",file="230916_sig_EP_diff_expression_results.tsv")
write.table(sig_EN6_stage,quote=F,row.names=F,sep="\t",file="230916_sig_EN6_diff_expression_results.tsv")
write.table(sig_EN7_stage,quote=F,row.names=F,sep="\t",file="230916_sig_EN7_diff_expression_results.tsv")

# nothing is significant
# problem of design matrix or contrasts matrix??
