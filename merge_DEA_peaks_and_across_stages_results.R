# Making venn diagrams and merging DEA tables with peak and across-stages results
...
for(i in stage){
  #peak
  DE_stage_specific[[i]] <- read.csv(file=paste("/Users/Marta/Documents/WTCHG/DPhil/Data/Results/Diff_v2/Voom/stage-specific/2017-02-28_sig_maxvals_",i,"_diff_expression_results_logFC1.csv",sep=""))
  ...
  # get contrast matrix results
    DE_across_stages[[i]] <- read.csv(file=paste("/Users/Marta/Documents/WTCHG/DPhil/Data/Results/Diff_v2/Voom/across-stages/2017-03-01_sig_",i,"_diff_expression_maxvals_across-stages_results_logFC1.csv",sep=""))
  ...
  write.csv(try,quote=F,row.names=F,
            file=paste("/Users/Marta/Documents/WTCHG/DPhil/Data/Results/Diff_v2/Voom/",
