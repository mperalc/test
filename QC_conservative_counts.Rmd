...
counts_cc <- counts_cc[all_ensembl_info_cc$ensembl_gene_id,] #keep genes in counts whose Ensembl geneID still exists in current genome build. 52699 remaining
...
dge_cc <- dge_cc[keep, , keep.lib.sizes=FALSE] # counts now has 17790 genes
